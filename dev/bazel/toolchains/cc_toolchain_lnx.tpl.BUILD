...
cc_toolchain_config(
    ...
    compile_flags_gcc = [%{compile_flags_gcc}],
    compile_flags_sycl = [%{compile_flags_sycl}],
    compile_flags_dpcc = [%{compile_flags_dpcc}],
    compile_flags_pedantic_cc = [%{compile_flags_pedantic_cc}],
    compile_flags_pedantic_gcc = [%{compile_flags_pedantic_gcc}],
    compile_flags_pedantic_sycl = [%{compile_flags_pedantic_sycl}],
    compile_flags_pedantic_dpcc = [%{compile_flags_pedantic_dpcc}],
    opt_compile_flags = [%{opt_compile_flags}],
    dbg_compile_flags = [%{dbg_compile_flags}],
    cxx_flags = [%{cxx_flags}],
    link_flags_cc = [%{link_flags_cc}],
    link_flags_sycl = [%{link_flags_sycl}],
    ...
    no_canonical_system_headers_flags_gcc = [%{no_canonical_system_headers_flags_gcc}],
    no_canonical_system_headers_flags_sycl = [%{no_canonical_system_headers_flags_sycl}],
    ...
    cpu_flags_gcc = {%{cpu_flags_gcc}},
    cpu_flags_sycl = {%{cpu_flags_sycl}},
